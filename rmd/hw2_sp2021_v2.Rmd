...
#create gender plot
gender_count_plot <- ggplot(SE_data) + 
  geom_bar(aes(x=Gender, group = Gender, fill= Gender))+ 
  labs( title = "Count by Gender", x="Gender", y="count")+ 
  theme_classic()

ln_Income05 <- log(SE_data$Income05)


income_count_plot <- ggplot(SE_data) + 
  geom_histogram(aes(x=ln_Income05, group = ln_Income05, fill= ln_Income05))+ 
  labs( title = "Count by Income", x="Income", y="count")+ 
  theme_classic()
